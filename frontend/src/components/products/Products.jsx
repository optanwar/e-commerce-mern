...
const ProductList = () => {
  ...
  return (
    <div className="bg-gradient-to-r from-blue-100 via-purple-200 to-pink-300 py-16 md:py-24 lg:py-32 xl:py-40">
                ...
                products.products.map((product) => (
                  ...
                  >
                    ...
                    <div className="p-6 space-y-4">
                      ...
                      <p className="text-lg text-gray-600 font-semibold">{product.price}$</p>
